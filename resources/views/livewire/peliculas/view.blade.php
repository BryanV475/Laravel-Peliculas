			...
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						...
						<i class="fa fa-plus"></i>  Crear Peliculas
						</div>
					</div>
				</div>
					...
					<table class="table table-bordered table-sm">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $row->directore->nombre }}</td>
								<td>{{ $row->formato->nombre }}</td>
								<td>{{ $row->nombre }}</td>
								<td>{{ $row->costo }}</td>
								<td>{{ $row->estreno }}</td>
								<td width="90">
