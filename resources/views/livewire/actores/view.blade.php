	...
	<div class="row justify-content-center">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						<div class="float-left">
							<h4><i class="fas fa-solid fa-user"></i>
							Lista de Actores </h4>
						</div>
						<div wire:poll.60s>
				...
				<div class="card-body">
						@include('livewire.actores.create')
						@include('livewire.actores.update')
